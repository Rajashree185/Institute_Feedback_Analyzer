          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#1b1c24]/50 border border-gray-800 focus:border-[#6366f1]/50 focus:ring-1 focus:ring-[#6366f1]/50 rounded-xl py-3 pl-11 pr-4 text-white text-sm outline-none transition-all duration-200 placeholder:text-gray-600"
